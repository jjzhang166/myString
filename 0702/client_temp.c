/*************************************************************************
	> File Name: client_temp.c
	> Author: xuxiaoqiang
	> Mail:353271054@qq.com 
	> Created Time: 2014年07月02日 星期三 23时46分58秒
 ************************************************************************/
...
int main()
{
	...
	temp=connect(fd_client,(struct sockaddr*)&server_addr,sizeof(server_addr));//涉及到的三次握手就在这个函数中实现的
	if(temp==-1)
	{
		printf("no concneting!\n");
		exit(-1);
	}
